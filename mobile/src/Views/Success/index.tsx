        ...
        <Container>
            ...
            <Content>
                <SuccessMessageContainer>
                    ...
                    {type === 'create_product' && (
                        <Title>
                            {translate('View_Success_ProductCreated')}
                        </Title>
                    )}
                    {type === 'edit_batch' && (
                    ...
                    {type === 'edit_product' && (
                        <Title>
                            {translate('View_Success_ProductUpdated')}
                        </Title>
                    )}
                    {type === 'delete_batch' && (
                    ...
                    {type === 'delete_product' && (
                        <Title>
                            {translate('View_Success_ProductDeleted')}
                        </Title>
                    )}
                    ...
                    {type === 'create_product' && (
                        <Description>
                            {translate(
                                'View_Success_ProductCreatedDescription'
                            )}
                        </Description>
                    )}
                    {type === 'edit_batch' && (
                    ...
                    {type === 'edit_product' && (
                        <Description>
                            {translate(
                                'View_Success_ProductUpdatedDescription'
                            )}
                        </Description>
                    )}
                    {type === 'delete_batch' && (
                    ...
                    {type === 'delete_product' && (
                        <Description>
                            {translate(
                                'View_Success_ProductDeletedDescription'
                            )}
                        </Description>
                    )}
                    ...
                    <ButtonContainer>
                        {userPreferences.isUserPremium && category_id && (
                            <Button onPress={handleNavigateToCategory}>
                                <ButtonText>
                                    {translate(
                                        'View_Success_Button_GoToCategory'
                                    )}
                                </ButtonText>
                            </Button>
                        )}
